...
export default function MaterialRequisitionPage() {
	...
	}, [authLoading, user, statusFilter, departmentFilter, fetchRequisitions]);
	...
	const filteredRequisitions = requisitions.filter((r) => {
		...
		return (
			r.requisition_number?.toLowerCase().includes(search) ||
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex">
			<div className="flex-1 flex flex-col">
				...
				<main className="flex-1 p-6 lg:px-8 xl:px-12 2xl:px-16 overflow-auto max-w-full mx-auto w-full">
					{/* Header */}
