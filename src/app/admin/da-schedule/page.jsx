				...
				<div className="px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-8 pt-16 max-w-[1800px] mx-auto">
					...
					<div className="mb-6">
						...
						<div className="flex items-center justify-between">
							<p className="text-sm text-gray-600">
								Manage Dearness Allowance (DA) rates for different years
							</p>
							<button
									...
									<tbody className="divide-y divide-gray-200">
										{schedule.map((entry) => (
											<tr key={entry.id} className="hover:bg-gray-50">
												...
												<td className="px-6 py-4 text-sm text-gray-600">
													{new Date(entry.effective_from).getFullYear()}
												</td>
					...
					<div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4 shadow-sm">
						...
						<ul className="text-xs text-blue-800 space-y-1">
							<li>
								• DA rates are applied based on the year and effective date
								range
							</li>
							<li>
								• When calculating salary, the system fetches DA for the
								specified year
							</li>
							<li>• Only active DA entries are used in salary calculations</li>
							<li>
								• You can have multiple DA rates for different time periods
							</li>
						</ul>
					</div>
				</div>
