      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <form onSubmit={handleSubmit}>
            <div className="bg-amber-50 border-2 border-gray-800 rounded-lg overflow-hidden max-w-5xl mx-auto">
              {/* Header Section */}
                ...
                <div className="w-64">
                  <div className="flex border-b border-gray-800">
                    ...
                    <input
                      ...
                      readOnly
                    />
                    <div className="px-3 py-2 text-sm font-semibold bg-amber-100 w-16">DATE:</div>
                  </div>
                  <div className="flex border-b border-gray-800">
                    <input
                      type="date"
