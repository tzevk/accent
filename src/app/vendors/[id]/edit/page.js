  ...
  const result = await fetchJSON(`/api/vendors/${vendorId.id}`);
        ...
        if (result.success) {
          ...
          setFormData({
            ...
            industry_category: vendorData.industry_category || '',
            status: vendorData.status || 'Active',
            contact_person: vendorData.contact_person || '',
            contact_designation: vendorData.contact_designation || '',
            phone: vendorData.phone || '',
            email: vendorData.email || '',
            address_street: vendorData.address_street || '',
            address_city: vendorData.address_city || '',
            address_state: vendorData.address_state || '',
            address_country: vendorData.address_country || '',
            address_pin: vendorData.address_pin || '',
            website: vendorData.website || '',
            gst_vat_tax_id: vendorData.gst_vat_tax_id || '',
            pan_legal_reg_no: vendorData.pan_legal_reg_no || '',
            msme_ssi_registration: vendorData.msme_ssi_registration || '',
            iso_certifications: vendorData.iso_certifications || '',
            other_compliance_docs: vendorData.other_compliance_docs || '',
            bank_name: vendorData.bank_name || '',
            bank_account_no: vendorData.bank_account_no || '',
            ifsc_swift_code: vendorData.ifsc_swift_code || '',
            currency_preference: vendorData.currency_preference || 'INR',
            payment_terms: vendorData.payment_terms || '',
            credit_limit: vendorData.credit_limit || '',
            previous_projects: vendorData.previous_projects || '',
            avg_quality_rating: vendorData.avg_quality_rating || '',
            avg_delivery_rating: vendorData.avg_delivery_rating || '',
            avg_reliability_rating: vendorData.avg_reliability_rating || '',
            blacklist_notes: vendorData.blacklist_notes || '',
        ...
        <div className="h-full px-4 pt-22">
          ...
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-accent-primary">Edit Vendor</h1>
