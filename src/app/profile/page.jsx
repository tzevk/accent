  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      if (j && j.success) {
        ...
        setError(
          (j && (j.error || j.message)) || `Failed to save (${res.status})`
        );
      }
    } catch (err) {
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                  ...
                  <form onSubmit={handleSave} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleChange('role_name', e.target.value)
                          }
                          className="w-full px-3 py-2 border rounded-lg"
                        />
                      </div>
                    ...
                    <div className="flex items-center space-x-3">
                      <button
                        type="submit"
                        disabled={saving}
                        className="px-4 py-2 rounded-lg bg-[#64126D] text-white disabled:opacity-60"
                      >
                        {saving ? 'Saving…' : 'Save'}
                      </button>
                      <button
              ...
              <aside className="space-y-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <p className="text-sm text-gray-600">
                    Change password from the Users section or request an admin
