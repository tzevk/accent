	...
	return (
		<div className="space-y-8">
			...
			<RichTextEditor
				...
				value={proposalData.description}
				onChange={(v) => set('description', v)}
				placeholder="Enter scope of work with formatting (Bold, Bullet points, etc.)..."
			/>
			<Note>
				Use the toolbar above to format text. Formatting will be preserved when
				viewing in project scope.
			</Note>
		</div>
	);
}
