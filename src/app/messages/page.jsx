...
export default function MessagesPage() {
      ...
      try {
        ...
        if (res.data?.messages) {
          ...
          res.data.messages.forEach((msg) => {
            const convId =
              msg.conversation_id ||
              `direct-${msg.sender_id}-${msg.receiver_id}`;
  ...
  const fetchConversationMessages = useCallback(
    async (conv) => {
      ...
      try {
        const otherParticipant = Array.from(conv.participants).find(
          (id) => id !== user.id
        );
        if (!otherParticipant) {
  ...
  const sendReply = async () => {
    ...
    setSending(true);
    try {
      const otherParticipant = Array.from(
  ...
  const handleForward = () => {
    ...
    setShowCompose(true);
    setComposeSubject(
      `Fwd: ${lastMsg.subject || selectedConversation.lastMessage?.subject || ''}`
    );
    setComposeBody(
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-center h-[calc(100vh-64px)]">
          <div
            className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#64126D]"
            aria-hidden="true"
          ></div>
  ...
  return (
    <div
      className="fixed inset-0 top-16 bg-gray-100 pr-2 pb-2 pt-2 pl-0 overflow-hidden"
      style={{
        left:
    ...
    >
      ...
      <div className="h-full flex flex-col bg-white rounded-r-xl border border-l-0 border-gray-200 shadow-sm overflow-hidden">
        ...
        >
          ...
          <nav
            className="w-40 lg:w-48 xl:w-56 2xl:w-60 bg-[#f3f2f1] flex flex-col border-r border-[#edebe9] flex-shrink-0 overflow-hidden"
            ...
            <div className="mt-0.5">
              <button
                onClick={() =>
                  setExpandedFolders({
                    ...expandedFolders,
                    favorites: !expandedFolders.favorites,
                  })
                }
              ...
              >
                <svg
                  className={`w-3 h-3 transition-transform ${expandedFolders.favorites ? 'rotate-90' : ''}`}
                  viewBox="0 0 16 16"
                  fill="currentColor"
                  aria-hidden="true"
                >
                ...
                >
                  {[
                    ...
                    >
                      ...
                      <span className="flex-1 text-left text-[#323130]">
                        {folder.label}
                      </span>
                      {folder.count > 0 && (
                        <span
                          className="text-[11px] font-semibold text-[#64126D]"
                          aria-hidden="true"
                        >
                          {folder.count}
                        </span>
            ...
            <div className="mt-0.5">
              <button
                onClick={() =>
                  setExpandedFolders({
                    ...expandedFolders,
                    folders: !expandedFolders.folders,
                  })
                }
                className="w-full flex items-center gap-1 px-2 py-0.5 text-[11px] font-semibold text-[#605e5c] hover:bg-[#e1dfdd]"
              ...
              >
                <svg
                  className={`w-3 h-3 transition-transform ${expandedFolders.folders ? 'rotate-90' : ''}`}
                  viewBox="0 0 16 16"
                  fill="currentColor"
                  aria-hidden="true"
                >
          ...
          {/* Message List Pane */}
          <div
            className="w-72 lg:w-80 xl:w-[360px] 2xl:w-[400px] bg-white border-r border-[#edebe9] flex flex-col flex-shrink-0"
            role="region"
          ...
          >
            ...
            <div className="p-2 border-b border-[#edebe9]">
              <div className="relative">
                <svg
                  className="w-4 h-4 absolute left-2 top-1/2 -translate-y-1/2 text-[#605e5c]"
                  viewBox="0 0 16 16"
                  fill="currentColor"
                  aria-hidden="true"
                >
            ...
            <div
              className="flex border-b border-[#edebe9]"
              role="tablist"
            ...
            >
              {loading ? (
                ...
                >
                  <div
                    className="animate-spin rounded-full h-5 w-5 border-2 border-[#64126D] border-t-transparent"
                    aria-hidden="true"
                  ></div>
                ...
                <div className="text-center py-12 px-4" role="status">
                  <svg
                    className="w-12 h-12 mx-auto text-[#c8c6c4] mb-3"
                    viewBox="0 0 48 48"
                    fill="currentColor"
                    aria-hidden="true"
                  >
                ...
                filteredConversations.map((conv) => (
                  ...
                  >
                    ...
                    {conv.unreadCount > 0 && (
                      <div
                        className="absolute left-0 top-0 bottom-0 w-[3px] bg-[#64126D]"
                        aria-hidden="true"
                      />
                    )}
                    ...
                    <div className="flex gap-3 px-4 py-3">
                      ...
                      <div
                        ...
                        style={{
                          backgroundColor: getAvatarColor(conv.displayName),
                        }}
                      >
          ...
          <div className="flex-1 bg-white flex flex-col min-w-0 overflow-hidden">
            {showCompose ? (
              ...
              <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex items-center gap-1 px-3 py-2 border-b border-[#edebe9] bg-[#faf9f8]">
                  <button
                    onClick={sendMessage}
                    disabled={
                      sending || composeTo.length === 0 || !composeBody.trim()
                    }
                ...
                <div className="flex-1 flex flex-col overflow-hidden">
                  ...
                  <div className="px-6 py-3 border-b border-[#edebe9]">
                    <label
                      htmlFor="compose-to"
                      className="block text-[13px] font-semibold text-[#323130] mb-2"
                    >
                      To
                    </label>
                    <div className="relative">
                      <div
                        className="flex flex-wrap items-center gap-2 min-h-[40px] p-2 border border-[#c8c6c4] rounded bg-white focus-within:border-[#64126D] focus-within:ring-1 focus-within:ring-[#64126D]"
                        role="group"
                      ...
                      >
                        {composeTo.map((r) => (
                          <span
                            key={r.id}
                            className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-[#ede4f0] text-[#64126D] rounded text-[13px]"
                            role="listitem"
                          >
                        ...
                        <input
                          ...
                          placeholder={
                            composeTo.length === 0 ? 'Select recipient...' : ''
                          }
                        ...
                        />
                        <svg
                          className="w-4 h-4 text-[#605e5c] flex-shrink-0"
                          viewBox="0 0 16 16"
                          fill="currentColor"
                          aria-hidden="true"
                        >
                      ...
                      {(recipientSearch || recipientSearch === ' ') &&
                        filteredUsers.length > 0 && (
                          <div
                            className="absolute left-0 right-0 top-full mt-1 bg-white border border-[#c8c6c4] shadow-lg rounded z-20 max-h-60 overflow-y-auto"
                            role="listbox"
                          ...
                          >
                            {filteredUsers.slice(0, 8).map((u) => (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="text-[14px] font-medium text-[#323130] truncate">
                                    {u.name || u.full_name || u.username}
                                  </div>
                                  <div className="text-[12px] text-[#605e5c] truncate">
                                    {u.email}
                                  </div>
                                </div>
                              </button>
                  ...
                  <div className="px-6 py-3 border-b border-[#edebe9]">
                    <div className="flex items-center justify-between mb-2">
                      <label
                        ...
                        className="block text-[13px] font-semibold text-[#323130]"
                      >
                        Subject
                      </label>
                      {!showCc && (
                        <button
                          ...
                          className="text-[12px] text-[#64126D] hover:underline"
                        >
                          + Add Cc
                        </button>
                      )}
                  ...
                  <div className="flex-1 px-6 py-3 flex flex-col overflow-hidden">
                    ...
                    {composeAttachments.length > 0 && (
                      <div className="flex flex-wrap gap-2 mt-2">
                        {composeAttachments.map((att, idx) => (
                          <span
                            key={idx}
                            className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-[#f3f2f1] rounded text-[12px] text-[#323130]"
                          >
                            <svg
                              className="w-3.5 h-3.5 text-[#605e5c]"
                              viewBox="0 0 16 16"
                              fill="currentColor"
                            >
                              <path d="M14.5 3a3.5 3.5 0 0 1 0 7H6v1h8.5a4.5 4.5 0 0 0 0-9A4.5 4.5 0 0 0 10 6.5V15a3 3 0 0 0 6 0V6h1v9a4 4 0 0 1-8 0V6.5A5.5 5.5 0 0 1 14.5 1v2z" />
                            </svg>
                            {att.original_name}
                            <button
                              onClick={() =>
                              ...
                              className="text-[#a19f9d] hover:text-[#323130]"
                    ...
                    <div className="flex items-center gap-1 mt-2 relative">
                      <input
                        ...
                        ref={composeFileRef}
                        className="hidden"
                        onChange={(e) => handleFileUpload(e, 'compose')}
                        aria-hidden="true"
                      />
                      <button
                        onClick={() => composeFileRef.current?.click()}
                        disabled={uploading}
                        className="p-2 text-[#605e5c] hover:bg-[#e1dfdd] rounded disabled:opacity-50"
                        title="Attach file"
                        aria-label="Attach file to compose"
                      >
                        <svg
                      ...
                      <button
                        onClick={() =>
                          setShowComposeEmojiPicker(!showComposeEmojiPicker)
                        }
                        className="p-2 text-[#605e5c] hover:bg-[#e1dfdd] rounded"
                        title="Insert emoji"
                        aria-label="Insert emoji to compose"
                      >
                        <svg
                          className="w-[18px] h-[18px]"
                          viewBox="0 0 20 20"
                      ...
                      {uploading && (
                        <span className="text-[11px] text-[#605e5c] ml-1">
                          Uploading...
                        </span>
                      )}
                      {showComposeEmojiPicker && (
                        <div
                          className="absolute bottom-full left-0 mb-2 bg-white border border-[#c8c6c4] rounded-lg shadow-lg p-2 z-30"
                          role="dialog"
              ...
              <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div
                  className="flex items-center gap-1 px-3 py-2 border-b border-[#edebe9] bg-[#faf9f8]"
                  role="toolbar"
                ...
                >
                  ...
                  <div
                    className="w-px h-5 bg-[#c8c6c4] mx-2"
                    aria-hidden="true"
                  />
                  <button
                  ...
                  {messagesLoading ? (
                    ...
                    <>
                      ...
                      <div className="px-6 lg:px-8 xl:px-10 py-5 border-b border-[#edebe9]">
                        <h1
                          className="text-[21px] font-semibold text-[#323130]"
                          style={{
                            fontFamily:
                              "'Segoe UI', 'Segoe UI Web (West European)', -apple-system, BlinkMacSystemFont, Roboto, sans-serif",
                          }}
                        >
                      ...
                      {/* Messages Thread */}
                      <div
                        className="divide-y divide-[#edebe9]"
                        role="list"
                      ...
                      >
                        {messages.map((msg, idx) => (
                          <div
                            key={msg.id}
                            className="px-6 lg:px-8 xl:px-10 py-5"
                            role="listitem"
                            aria-label={`Message from ${msg.sender_id === user?.id ? 'you' : msg.sender_name}, ${formatFullDate(msg.created_at)}`}
                          >
                            {/* Message Header Row */}
                      ...
                      <div
                        className="px-6 lg:px-8 xl:px-10 py-3"
                        role="region"
                        aria-label="Reply"
                      >
                        <div className="flex items-start gap-4">
                              ...
                              <div className="flex items-center justify-between px-2 py-1 border-t border-[#edebe9] rounded-b-lg bg-[#faf9f8]">
                                <div className="flex items-center gap-1 relative">
                                  ...
                                  <button
                                    ...
                                    disabled={uploading}
                                    className="p-1.5 text-[#605e5c] hover:bg-[#e1dfdd] rounded disabled:opacity-50"
                                    title="Attach file"
                                  ...
                                  <button
                                    ...
                                    className="p-1.5 text-[#605e5c] hover:bg-[#e1dfdd] rounded"
                                    title="Insert emoji"
                                    aria-label="Insert emoji"
                                  >
                                    <svg
              ...
              /* Empty State */
              <div
                className="flex-1 flex flex-col items-center justify-center text-[#605e5c]"
                role="status"
                aria-label="No message selected"
              >
                <svg
                  className="w-24 h-24 text-[#c8c6c4] mb-4"
                  viewBox="0 0 96 96"
                  fill="currentColor"
                  aria-hidden="true"
                >
