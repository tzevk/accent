  ...
  const renderAddCompanyForm = () => (
    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
      ...
      <div className="flex border-b border-gray-200 bg-white px-6 pt-4">
        <button
          onClick={() => setFormActiveTab('details')}
        ...
        <button
          onClick={() => setFormActiveTab('contact')}
          className={`px-6 py-3 text-sm font-medium border-b-2 rounded-t-md transition-colors ${
        ...
        <button
          onClick={() => setFormActiveTab('location')}
          className={`px-6 py-3 text-sm font-medium border-b-2 rounded-t-md transition-colors ${
            formActiveTab === 'location'
              ? 'border-[#64126D] text-[#64126D] bg-purple-50'
              : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
          }`}
        >
        ...
        <button
          onClick={() => setFormActiveTab('additional')}
          className={`px-6 py-3 text-sm font-medium border-b-2 rounded-t-md transition-colors ${
