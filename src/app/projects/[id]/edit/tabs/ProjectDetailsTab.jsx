                ...
                .filter(
                  (d) =>
                    ...
                    (typeof newInputDocument === "string" &&
                      (d.name?.toLowerCase().includes(newInputDocument.toLowerCase()) ||
                        d.doc_key?.toLowerCase().includes(newInputDocument.toLowerCase()))) ||
                    (typeof newInputDocument === "object" && newInputDocument.description &&
                      (d.name?.toLowerCase().includes(newInputDocument.description.toLowerCase()) ||
                        d.doc_key?.toLowerCase().includes(newInputDocument.description.toLowerCase())))
                )
                .slice(0, 8)
                .map((d) => (
                  <button
