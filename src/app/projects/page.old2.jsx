  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute -top-[20%] -right-[15%] h-[900px] w-[900px] rounded-full"
          style={{
            background:
              'radial-gradient(circle at 35% 35%, rgba(167,139,250,0.18) 0%, rgba(147,107,232,0.12) 20%, rgba(139,92,246,0.08) 35%, rgba(124,58,237,0.04) 55%, transparent 75%)',
            filter: 'blur(100px)',
        ...
        />
        <div
          className="absolute -bottom-[20%] -left-[15%] h-[1000px] w-[1000px] rounded-full"
          style={{
            background:
              'radial-gradient(circle at 65% 65%, rgba(236,72,153,0.14) 0%, rgba(219,39,119,0.09) 25%, rgba(219,39,119,0.06) 40%, rgba(190,24,93,0.03) 60%, transparent 75%)',
            filter: 'blur(110px)',
        ...
        />
        <div
          className="absolute top-[25%] right-[20%] h-[600px] w-[600px] rounded-full"
          style={{
            background:
              'radial-gradient(circle, rgba(99,102,241,0.10) 0%, rgba(79,70,229,0.06) 30%, rgba(67,56,202,0.03) 50%, transparent 70%)',
            filter: 'blur(85px)',
        ...
        />
        <div
          className="absolute bottom-[30%] left-[25%] h-[550px] w-[550px] rounded-full"
          style={{
            background:
              'radial-gradient(circle, rgba(168,85,247,0.08) 0%, rgba(147,51,234,0.05) 35%, transparent 65%)',
            filter: 'blur(90px)',
        ...
        <div
          ...
          style={{
            backgroundImage:
              'radial-gradient(circle, rgba(100,18,109,0.9) 0.5px, transparent 0.5px)',
      ...
      <style jsx>{`
        @keyframes orbit-smooth {
          ...
          25% {
            transform: translate(60px, -70px) scale(1.08) rotate(8deg);
            opacity: 0.92;
          }
          50% {
            transform: translate(90px, -40px) scale(1.12) rotate(12deg);
            opacity: 0.88;
          }
          75% {
            transform: translate(40px, 50px) scale(0.96) rotate(-6deg);
            opacity: 0.9;
          }
        }
        @keyframes drift {
      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full overflow-y-auto">
          <div className="px-8 pt-22 pb-8">
            {/* Header */}
            <div
              className="mb-8 animate-slide-in-right"
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p
                    className="text-sm font-medium ml-15"
                    style={{ color: '#64748b', letterSpacing: '0.01em' }}
                  >
                    Manage and track your client projects with precision
                  </p>
                </div>
                <div className="flex items-center gap-3">
                  <button
                    ...
                    style={{
                      ...
                      boxShadow:
                        '0 10px 40px -10px rgba(139, 92, 246, 0.6), 0 0 0 1px rgba(139, 92, 246, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
                      transform: 'translateY(0)',
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        '0 20px 50px -10px rgba(139, 92, 246, 0.7), 0 0 0 1px rgba(139, 92, 246, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.3)';
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform =
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      '0 16px 32px rgba(15, 23, 42, 0.1), 0 8px 16px rgba(139, 92, 246, 0.15)';
                ...
                >
                  <div className="p-6 relative">
                    <div
                      className="absolute top-0 left-0 w-1.5 h-16 rounded-r-full transition-all duration-300 group-hover:h-20"
                      style={{
                        background:
                    ...
                    <div
                      ...
                      style={{
                        background:
                          'radial-gradient(circle at top right, rgba(139, 92, 246, 0.03), transparent 70%)',
                      }}
                    />
                    <div className="flex items-start justify-between gap-4 relative">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2.5">
                          ...
                          <div
                            ...
                            style={{
                              background:
                                'linear-gradient(135deg, rgba(139, 92, 246, 0.1), rgba(124, 58, 237, 0.08))',
                      ...
                      <div
                        className="p-3.5 rounded-xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-3"
                        style={{
                          background:
                            'linear-gradient(135deg, #f8f7ff 0%, #f3f1ff 100%)',
                          border: '1px solid rgba(139, 92, 246, 0.15)',
                ...
                <div
                  className="rounded-2xl transition-all duration-400 cursor-pointer group relative overflow-hidden animate-scale-in delay-100"
                  style={{
                    background:
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = 'translateY(-6px)';
                    e.currentTarget.style.boxShadow =
                      '0 16px 32px rgba(15, 23, 42, 0.1), 0 8px 16px rgba(59, 130, 246, 0.15)';
                    e.currentTarget.style.borderColor =
                      'rgba(59, 130, 246, 0.3)';
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  <div className="p-6 relative">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          'radial-gradient(circle at top right, rgba(59, 130, 246, 0.03), transparent 70%)',
                      }}
                    />
                    <div className="flex items-start justify-between gap-4 relative">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2.5">
                          ...
                          <div
                            ...
                            style={{
                              background:
                                'linear-gradient(135deg, rgba(59, 130, 246, 0.1), rgba(37, 99, 235, 0.08))',
                ...
                <div
                  className="rounded-2xl transition-all duration-400 cursor-pointer group relative overflow-hidden animate-scale-in delay-200"
                  style={{
                    background:
                      'linear-gradient(135deg, #ffffff 0%, #fafafa 100%)',
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = 'translateY(-6px)';
                    e.currentTarget.style.boxShadow =
                      '0 16px 32px rgba(15, 23, 42, 0.1), 0 8px 16px rgba(34, 197, 94, 0.15)';
                    e.currentTarget.style.borderColor =
                      'rgba(34, 197, 94, 0.3)';
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  <div className="p-6 relative">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          'radial-gradient(circle at top right, rgba(34, 197, 94, 0.03), transparent 70%)',
                      }}
                    />
                    <div className="flex items-start justify-between gap-4 relative">
                      <div className="flex-1">
                      ...
                      <div
                        ...
                        style={{
                          background:
                            'linear-gradient(135deg, #f0fdf6 0%, #e6f9ed 100%)',
                          border: '1px solid rgba(34, 197, 94, 0.15)',
                ...
                <div
                  className="rounded-2xl transition-all duration-400 cursor-pointer group relative overflow-hidden animate-scale-in delay-300"
                  style={{
                    background:
                      'linear-gradient(135deg, #ffffff 0%, #fafafa 100%)',
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = 'translateY(-6px)';
                    e.currentTarget.style.boxShadow =
                      '0 16px 32px rgba(15, 23, 42, 0.1), 0 8px 16px rgba(245, 158, 11, 0.15)';
                    e.currentTarget.style.borderColor =
                      'rgba(245, 158, 11, 0.3)';
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  <div className="p-6 relative">
                    ...
                    <div
                      ...
                      style={{
                        background:
                          'radial-gradient(circle at top right, rgba(245, 158, 11, 0.03), transparent 70%)',
                      }}
                    />
                    <div className="flex items-start justify-between gap-4 relative">
                      <div className="flex-1">
            ...
            <div className="space-y-6">
              {activeTab === 'list' && (
                <div className="space-y-6">
                      ...
                      <div className="relative w-full max-w-md group">
                        <input
                          ...
                          style={{
                            ...
                            boxShadow:
                              '0 4px 16px rgba(139, 92, 246, 0.06), inset 0 1px 0 rgba(255, 255, 255, 0.8)',
                            color: '#1e293b',
                          }}
                          onFocus={(e) => {
                            ...
                            e.target.style.boxShadow =
                              '0 8px 24px rgba(139, 92, 246, 0.12), inset 0 1px 0 rgba(255, 255, 255, 0.9)';
                          }}
                          onBlur={(e) => {
                            e.target.style.borderColor =
                  ...
                  {showFilters && (
                    <div
                      className="mt-4 rounded-3xl p-6 animate-slide-in-up"
                      style={{
                        background:
                          ...
                          <button
                            ...
                            style={{
                              background:
                                'linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)',
                              boxShadow:
                                '0 8px 24px -4px rgba(139, 92, 246, 0.5), 0 0 0 1px rgba(139, 92, 246, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.2)',
                              letterSpacing: '0.02em',
                            }}
                            onMouseEnter={(e) => {
                              e.currentTarget.style.transform =
                              ...
                              e.currentTarget.style.boxShadow =
                                '0 12px 32px -4px rgba(139, 92, 246, 0.6), 0 0 0 1px rgba(139, 92, 246, 0.2), inset 0 1px 0 rgba(255, 255, 255, 0.3)';
                            }}
                            onMouseLeave={(e) => {
                              e.currentTarget.style.transform =
                                'translateY(0) scale(1)';
                  ...
                  {/* Projects Table */}
                  <div
                    className="rounded-3xl overflow-hidden animate-slide-in-up delay-300"
                    style={{
                      background:
                        ...
                        <div className="space-y-4">
                          {[...Array(6)].map((_, i) => (
                            <div
                              ...
                              style={{
                                background:
                                  'linear-gradient(90deg, rgba(249, 250, 251, 0.8) 0%, rgba(243, 232, 255, 0.4) 50%, rgba(249, 250, 251, 0.8) 100%)',
                                backgroundSize: '200% 100%',
                                animation:
                        ...
                        >
                          ...
                          >
                            <tr>
                              ...
                              >
                                <button
                                  className="inline-flex items-center gap-1.5 hover:text-purple-600 transition-all duration-300 hover:scale-105"
                              ...
                              <th
                                className="px-5 py-4 text-right text-xs font-black uppercase tracking-wider"
                                style={{
                                  color: '#64748b',
                                  letterSpacing: '0.08em',
                                }}
                            ...
                            {projects
                              ...
                              .map((project, _idx) => (
                                <tr
                                  ...
                                  onMouseEnter={(e) => {
                                    e.currentTarget.style.background =
                                      'linear-gradient(90deg, rgba(243, 232, 255, 0.6) 0%, rgba(243, 232, 255, 0.3) 100%)';
                                    e.currentTarget.style.transform =
                                      'translateX(4px) scale(1.005)';
                                    e.currentTarget.style.boxShadow =
                                ...
                                >
                                  ...
                                  <td className="px-5 py-4 whitespace-nowrap">
                                    <div>
                                      ...
                                      >
                                        <span
                                          className="inline-flex items-center justify-center w-8 h-8 rounded-xl text-xs font-black transition-all duration-300"
                                          style={{
                                            background:
                                      ...
                                      <div
                                        className="text-xs font-medium mt-1.5 max-w-xs truncate"
                                        style={{ color: '#64748b' }}
                                      >
                                        {project.description}
                                      </div>
                                      <div
                                        className={`text-[11px] font-bold uppercase mt-2 tracking-wide ${getPriorityColor(project.priority)}`}
                                      >
                                        {formatLabel(
                                  ...
                                  <td className="px-5 py-4">
                                    ...
                                    <div
                                      className="text-xs font-medium mt-1 px-2 py-1 rounded-lg inline-block"
                                      style={{
                                  ...
                                  <td
                                    className="px-5 py-4 whitespace-nowrap text-sm font-bold"
                                    style={{ color: '#1e293b' }}
                                  >
                                    {(() => {
                                      try {
                                      ...
                                      >
                                        <div
                                          ...
                                          style={{
                                            ...
                                            background:
                                              'linear-gradient(90deg, #a78bfa 0%, #8b5cf6 50%, #7c3aed 100%)',
                                            boxShadow:
                                              '0 0 10px rgba(139, 92, 246, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
                                          }}
                                        />
                                      </div>
                                      <span
                                        className="text-xs font-black min-w-[35px]"
                                        style={{ color: '#64748b' }}
                                      >
                                        {project.progress || 0}%
                                      </span>
                                    ...
                                    <div className="flex items-center justify-end gap-2">
                                      ...
                                      <button
                                        ...
                                        onMouseEnter={(e) => {
                                          ...
                                          e.currentTarget.style.transform =
                                            'translateY(-2px) scale(1.08) rotate(5deg)';
                                          e.currentTarget.style.boxShadow =
      ...
      <button
        ...
        style={{
          ...
          boxShadow:
            '0 12px 40px rgba(139, 92, 246, 0.4), 0 0 0 0 rgba(139, 92, 246, 0.5)',
