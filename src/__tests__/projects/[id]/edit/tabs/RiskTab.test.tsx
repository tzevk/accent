...
describe('RiskTab', () => {
  ...
  it('renders risk details correctly', () => {
    render(<RiskTab form={mockForm} handleChange={vi.fn()} />);

    expect(
      screen.getByDisplayValue('High temperature environment')
    ).toBeInTheDocument();
  ...
  it('calls handleChange when fields change', async () => {
    ...
    render(<RiskTab form={mockForm} handleChange={handleChange} />);
