...
describe('ProjectDetailsTab', () => {
    it('renders project details fields correctly', () => {
        ...
        expect(container.querySelector('input[name="project_id"]')).toHaveValue('PRJ-101')
        expect(container.querySelector('input[name="name"]')).toHaveValue('Accent Build')
        expect(container.querySelector('input[name="client_name"]')).toHaveValue('Google')
        expect(container.querySelector('select[name="contract_type"]')).toHaveValue('EPC')
    })
