...
describe('ProjectTeamTab', () => {
    const mockAvailableUsers = [
        { id: 1, employee_code: 'EMP001', full_name: 'Alice Smith', email: 'alice@example.com', role_name: 'Designer' }
    ]

    const mockTeamMembers = [
        { id: 10, employee_id: 'EMP101', name: 'Bob Jones', email: 'bob@example.com', department: 'Piping', position: 'Lead', role: 'Engineer' }
    ]
